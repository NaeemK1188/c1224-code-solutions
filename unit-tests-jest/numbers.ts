 ...
 */
// we get object literal from main, and we return an object literal with key:string and value:unknown type
export function multiplyBy(
  ...
  Object.entries(obj).forEach(([key, value]) => {
    ...
    // else if its not a type number return normal key/value; no multiplication
    else {
      result[key] = value;
    }
  });
