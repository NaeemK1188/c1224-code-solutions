...
const secondBookAuthor: string = bookshelf[1].author;
console.log("name of the second's book author:", secondBookAuthor);

const firstBookISBN: string = bookshelf[0].isbn; // or [0]['isbn'] => [row:0][col:2]
console.log('ISBN of the first book', firstBookISBN);

const titleThirdBook: string = bookshelf[2].title;
