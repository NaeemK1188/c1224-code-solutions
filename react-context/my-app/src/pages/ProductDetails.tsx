...
export function ProductDetails() {
  ...
  function handleAddToCart() {
    ...
    // alert(`Added ${product?.name} to cart`); instead showing alert every time
    // users add to cart we want to update the actual cart with value where the badge og zero
    // is not updated
    addToCart(product);
