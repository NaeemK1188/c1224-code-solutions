...
function ItemCard({ item }: CardProps) {
  return (
    // creating the destination dynamically
    // we put the Link on the outer div not on the actual <h5> so it highlights h3 as soon as we reach the
    // out div
    <Link
      to={`/details/${item.itemId}`}
